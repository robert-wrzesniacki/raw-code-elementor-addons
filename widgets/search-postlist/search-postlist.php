...
class Search_PostList extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'nosearch_text',
			[
				'label' => esc_html__( 'No Search Found Text', 'rawcodeplugin' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Nothing was found.', 'rawcodeplugin' ),
			]
		);
	...
	protected function render() {
		...
		<?php } else { 
			echo '<section class="rcode-postlist-container '.$style_container.'">';
			echo '<div class="rcode-nosearch">';
			echo $settings['nosearch_text'];
			echo '</div></section>';
